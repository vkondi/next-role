...
export const ResumeProfileSchema = z.object({
  ...
  techStack: z.array(z.string()).describe('Technologies and languages known'),
  strengthAreas: z
    .array(z.string())
  ...
  rawText: z.string().optional().describe('Original resume text for reference'),
});
...
export const CareerPathSchema = z.object({
  ...
  description: z
    .string()
    .describe('Description of the role and responsibilities'),
  marketDemandScore: z
    .number()
    .min(0)
    .max(100)
  ...
  reasoning: z.string().describe('Explanation of why this path suits the user'),
...
export const RoadmapPhaseSchema = z.object({
  ...
  skillsFocus: z.array(z.string()).describe('Skills to focus on in this phase'),
  learningDirection: z.string().describe('Learning direction and goals'),
  projectIdeas: z.array(z.string()).describe('Project ideas to apply learning'),
