  ...
  return (
    ...
    >
      <div className="space-y-3 sm:space-y-4">
        {/* Header */}
        <div>
          <h3 className="heading-4 text-emerald-700 text-lg sm:text-xl">
            {path.roleName}
          </h3>
          <p className="text-small text-xs sm:text-sm mt-1">
            {path.description}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          <div className="flex items-start sm:items-center gap-2">
            ...
            <div className="min-w-0">
              <p className="text-small text-xs sm:text-sm font-semibold">
                Market Demand
              </p>
        ...
        <div className="flex gap-1 sm:gap-2 flex-wrap">
          <span
            className={`px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold ${effortColors[path.effortLevel]}`}
          >
            Effort: {path.effortLevel}
          </span>
          <span
            className={`px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold ${rewardColors[path.rewardPotential]}`}
          >
        ...
        {/* Skills */}
        <div>
          <p className="text-small text-xs sm:text-sm font-semibold mb-1 sm:mb-2">
            Required Skills
          </p>
